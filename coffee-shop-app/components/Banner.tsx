...
const Banner = () => {
  return (
    ...
    <View className="rounded-lg  items-center">
        ...
        <View
        className='absolute w-full h-[90px] -top-1 items-center bg-[#222222] pb-12'
        />
            <Image   
            source={require('../assets/images/banner.png')}
            className="w-[90%] h-44 rounded-3xl"
            />
            ...
            >
                ...
                <Text
                  ...
                  {/* ----- */}
                <View
                    className='bg-[#222222] w-[75%] h-7 top-7'>
                </View>

                <View
                  className='bg-[#222222] w-[60%] h-7 top-12'>
                </View>
