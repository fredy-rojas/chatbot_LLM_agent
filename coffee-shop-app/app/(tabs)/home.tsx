...
const home = () => {
    ...
    useEffect(() =>{
        // empty, no listeaning to anything
        const loadProducts = async () => {
            try {
                const productsData = await fetchProducts();
                
                // console.log(productsData); // help to load the product in terminal 
        ...
        loadProducts(); //this run the function
                    ...
                    >
                        ...
                        <View
                            ...
                            <TouchableOpacity
                                ...
                                >
                                <View
                                    className='mr-2 p-2 -mt-1 rounded-xl bg-app_orange_color' 
                                    // style={{ backgroundColor: "#C67C4E" }}
                                    >
                                    <AntDesign name="plus" size={20} color="white" />
                                    {/* <FontAwesome6 name="plus" size={20} color="white" weight="bold" /> */}
                                </View>
                            </TouchableOpacity>
